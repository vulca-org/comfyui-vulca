...
Cultural art evaluation and Brief-driven creation nodes for ComfyUI, synced with the Vulca SDK v0.23.1 package line. Score any generated image on L1-L5 dimensions across 13 traditions.
...
- Python 3.10+
- `vulca>=0.23.1` ([PyPI](https://pypi.org/project/vulca/))
